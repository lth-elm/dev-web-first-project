    ...
    <main>
      ...
      <div class="main">
          <article>
              ...
              <p style="color: red;"><em>Pages "terminés" : Home, C#, Brainstorming, Memo Physique, Cryptomonnaie et Sign In.</em></p>
              <p>>>> Faire une présentation du site et des différentes fonctionnalitées ajoutées.</p>
